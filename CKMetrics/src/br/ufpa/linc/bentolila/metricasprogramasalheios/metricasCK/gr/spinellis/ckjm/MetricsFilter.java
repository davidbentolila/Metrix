...
//    static Logger logger = Logger.getLogger("br.ufpa.linc.bentolila.metricasprogramasalheios.metricasCK.gr.spinellis.ckjm");
...
//	    	logger.	    	System.err.println("Error loading " + clspec + " from " + jar + ": " + e);
	    }
	} else {
	    try {
