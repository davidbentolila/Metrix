...
import br.ufpa.linc.MetriX.view.prefuse.util.collections.DefaultLiteralComparator;
 ...
 * retrieved using the {@link Table#getMetadata(String)} method.
...
public class ColumnMetadata implements ColumnListener {
    ...
    /**
     * Get the number of unique values in the 
    ...
    /**
     * Get the mean value of numeric values in the  If this column
    ...
    /**
     * Get the standard deviation of numeric values in the  If this column
     * does not contain numeric values, this method will result in an
     * exception being thrown.
    ...
    /**
     * Get the sum of numeric values in the  If this column
     * does not contain numeric values, this method will result in an
     * exception being thrown.
