...
import br.ufpa.linc.MetriX.view.prefuse.visual.tuple.TableAggregateItem;
...
public class AggregateTable extends VisualTable {
     ...
     */
    public void addToAggregate(int row, Node member) {
     ...
     */
    public void removeFromAggregate(int row, Node member) {
        validRowCheck(row, true);
     ...
     */
    public boolean aggregateContains(int row, Node member) {
     ...
     */
    protected int getAggregatedRow(int row, Node member) {
