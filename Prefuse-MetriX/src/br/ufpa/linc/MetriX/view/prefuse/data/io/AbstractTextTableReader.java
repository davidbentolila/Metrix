...
import br.ufpa.linc.MetriX.view.prefuse.data.parser.DataParseException;
import br.ufpa.linc.MetriX.view.prefuse.data.parser.DataParser;
import br.ufpa.linc.MetriX.view.prefuse.data.parser.ParserFactory;
import br.ufpa.linc.MetriX.view.prefuse.data.parser.TypeInferencer;
...
public abstract class AbstractTextTableReader extends AbstractTableReader {
    ...
    /**
     * @see AbstractTableReader#readTable(InputStream)
     */
