...
import br.ufpa.linc.MetriX.view.prefuse.data.expression.ExpressionVisitor;
import br.ufpa.linc.MetriX.view.prefuse.data.expression.ObjectLiteral;
import br.ufpa.linc.MetriX.view.prefuse.data.expression.Predicate;
import br.ufpa.linc.MetriX.view.prefuse.util.PredicateChain;
...
public abstract class EncoderAction extends ItemAction {
     ...
     * Create a new EncoderAction that processes the specified group.
     * @param group the name of the group to process
     * @param filter the filtering {@link Predicate}
     */
    ...
    /**
     * Add a mapping rule to this Encoder This method is protected,
    ...
    /**
     * @see Action#setVisualization(Visualization)
     */
