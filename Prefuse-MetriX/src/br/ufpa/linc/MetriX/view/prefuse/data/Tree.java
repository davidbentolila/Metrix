 ...
 * tables, and use {@link Node} and
 * {@link Edge} instances to provide object-oriented access
...
public class Tree extends Graph {
    ...
    /**
     * @see br.ufpa.linc.view.prefuse.data.Graph#createLinkTable()
     */
    ...
    /**
     * @see br.ufpa.linc.view.prefuse.data.Graph#updateDegrees(int, int, int, int)
     */
