package br.ufpa.linc.MetriX.view.prefuse.data.query;
...
import br.ufpa.linc.MetriX.view.prefuse.data.expression.AbstractPredicate;
import br.ufpa.linc.MetriX.view.prefuse.data.search.KeywordSearchTupleSet;
import br.ufpa.linc.MetriX.view.prefuse.data.search.PrefixSearchTupleSet;
 ...
 * of the {@link br.ufpa.linc.view.prefuse.data.search.SearchTupleSet} class from the
 * {@link br.ufpa.linc.view.prefuse.data.search} package can be used to control the type of
 * search index used.
 * 
 * @author <a href="http://jheer.org">jeffrey heer</a>
 * @see br.ufpa.linc.view.prefuse.data.search.SearchTupleSet
 */
public class SearchQueryBinding extends DynamicQueryBinding {
    ...
    public SearchQueryBinding(TupleSet ts, String field) {
        this(ts, field, new KeywordSearchTupleSet());
    }
     ...
     * @param ts the TupleSet to query
     * @param field the data field (Table column) to query
     * @param set the {@link br.ufpa.linc.view.prefuse.data.search.SearchTupleSet} to use.
     */
     ...
     * @return the {@link br.ufpa.linc.view.prefuse.data.search.SearchTupleSet} used by this
     ...
     * @return a {@link br.ufpa.linc.view.prefuse.util.ui.JSearchPanel} bound to this
     * dynamic query.
     * @see br.ufpa.linc.view.prefuse.data.query.DynamicQueryBinding#createComponent()
     */
