 ...
 * {@link Graph#getSpanningTree()} method.
 * 
...
public class JPrefuseTree extends JTree {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 7017525337318625818L;
	private Tree m_tree;
    ...
    public class PrefuseTreeModel implements TreeModel, GraphListener {
        ...
        /**
         * @see GraphListener#graphChanged(Graph, java.lang.String, int, int, int, int)
         */
