...
import br.ufpa.linc.MetriX.view.prefuse.action.layout.AxisLabelLayout;
 ...
 * @see br.ufpa.linc.view.prefuse.action.layout.AxisLabelLayout
 */
public class AxisLabelAnimator extends ItemAction {
    ...
    /**
     * @see br.ufpa.linc.view.prefuse.action.GroupAction#run(double)
     */
