...
package br.ufpa.linc.MetriX.view.prefuse.data.expression.parser;

import java.io.StringReader;
import java.util.logging.Logger;

import br.ufpa.linc.MetriX.view.prefuse.action.assignment.ColorAction;
import br.ufpa.linc.MetriX.view.prefuse.action.assignment.FontAction;
import br.ufpa.linc.MetriX.view.prefuse.action.assignment.ShapeAction;
import br.ufpa.linc.MetriX.view.prefuse.action.assignment.SizeAction;
...
import br.ufpa.linc.MetriX.view.prefuse.data.expression.ArithmeticExpression;
...
import br.ufpa.linc.MetriX.view.prefuse.data.expression.FunctionTable;
...
import br.ufpa.linc.MetriX.view.prefuse.data.expression.NumericLiteral;
...
import br.ufpa.linc.MetriX.view.prefuse.data.expression.XorPredicate;
 ...
 * expression are parsed into {@link Expression}
 ...
 * a text String to an {@link Expression}, use
 ...
 * write {@link Predicate} instances for querying and filtering a table
 ...
 * the {@link TupleSet#tuples(Predicate)} method
 * uses a Predicate to filter the requested set of tuples, and the
 * {@link Table#addColumn(java.lang.String,Expression)}
 ...
 * is a key component of  dynamic query bindings, and is used to
 * create the rule chains evaluated by the
 * {@link DefaultRendererFactory},
 * {@link ColorAction},
 * {@link ShapeAction},
 * {@link FontAction}, and
 * {@link SizeAction} classes.
 * </p>
 * <p>
 * The {@link Expression} interface is quite simple: given a single
 ...
 * {@link ExpressionParser#parse(java.lang.String)}
 ...
 * function by creating a new instance of the {@link Function} interface
 * and registering it with the {@link FunctionTable} class.
 * </p>
 * <p>
 ...
 *     method. See {@link Graph#getSpanningTree()} for more.
 *   </li>
 ...
 *     default method. See {@link Graph#getSpanningTree()} for
 *     more.
 *   </li>
 * </ul>
 *
