package br.ufpa.linc.MetriX.view.prefuse.activity;
 ...
 * {@link Activity#run()},
 * {@link Activity#runAt(long)}, and 
 * {@link Activity#runAfter(Activity)}
 * methods. These will automatically call the
 * appropriate methods with the ActivityManager.</p>
 * 
 * <p>For {@link Action} instances, one can also register
 * the actions with a {@link Visualization} and use the
