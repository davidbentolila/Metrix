...
import br.ufpa.linc.MetriX.view.prefuse.util.force.DragForce;
import br.ufpa.linc.MetriX.view.prefuse.util.force.ForceItem;
import br.ufpa.linc.MetriX.view.prefuse.util.force.ForceSimulator;
import br.ufpa.linc.MetriX.view.prefuse.util.force.NBodyForce;
import br.ufpa.linc.MetriX.view.prefuse.util.force.SpringForce;
 ...
 * this value.</p>
 * 
 * <p>The {@link br.ufpa.linc.view.prefuse.util.force.ForceSimulator} used to drive this layout
 ...
 * {@link br.ufpa.linc.view.prefuse.util.force.Force} components. Each node in the layout is
 * mapped to a {@link br.ufpa.linc.view.prefuse.util.force.ForceItem} instance and each edge
 * to a {@link br.ufpa.linc.view.prefuse.util.force.Spring} instance for storing the state
 * of the simulation. See the {@link br.ufpa.linc.view.prefuse.util.force} package for more.</p>
 * 
...
public class ForceDirectedLayout extends Layout {
    ...
    /**
     * @see br.ufpa.linc.view.prefuse.action.Action#run(double)
     */
...
//                }
     ...
     * @see br.ufpa.linc.view.prefuse.util.PrefuseLib#setX(VisualItem, VisualItem, double)
     * @see br.ufpa.linc.view.prefuse.util.PrefuseLib#setY(VisualItem, VisualItem, double)
     */
