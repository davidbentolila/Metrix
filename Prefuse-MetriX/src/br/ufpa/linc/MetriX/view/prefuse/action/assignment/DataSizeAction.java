...
public class DataSizeAction extends SizeAction {
     ...
     * {@link Constants#QUANTILE_SCALE}. If a quantile scale is
     ...
     *  length sizes.
     * @see PrefuseLib#getSize2D(double)
     */
     ...
     * @see SizeAction#setDefaultSize(double)
    ...
    /**
     * @see SizeAction#getSize(VisualItem)
     */
