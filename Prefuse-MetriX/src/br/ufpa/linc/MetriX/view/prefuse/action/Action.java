 ...
 * {@link Visualization#putAction(String, Action)} to do this. This
 ...
 * can then run the Actions using the {@link Visualization#run(String)}
 * method and other similar methods of the {@link Visualization} class.
 * </p>
 * 
...
public abstract class Action extends Activity {
     ...
     * @see activity.Activity#run(long)
     */
