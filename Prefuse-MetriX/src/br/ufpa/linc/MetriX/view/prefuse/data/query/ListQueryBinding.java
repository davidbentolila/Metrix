...
import br.ufpa.linc.MetriX.view.prefuse.data.expression.ComparisonPredicate;
import br.ufpa.linc.MetriX.view.prefuse.data.expression.Expression;
import br.ufpa.linc.MetriX.view.prefuse.data.expression.Literal;
...
import br.ufpa.linc.MetriX.view.prefuse.util.ui.JToggleGroup;
...
public class ListQueryBinding extends DynamicQueryBinding {
     ...
     * @return a {@link br.ufpa.linc.view.prefuse.util.ui.JToggleGroup} of check boxes bound to
     * this dynamic query.
     * @see DynamicQueryBinding#createComponent()
     */
    ...
    /**
     * Creates a new group of check boxes for interacting with the query.
     * @return a {@link JToggleGroup} of check boxes bound to
     * this dynamic query.
     */
     ...
     * @return a {@link JToggleGroup} of radio buttons bound to
     * this dynamic query.
     */
