...
import br.ufpa.linc.MetriX.view.prefuse.data.column.ColumnFactory;
import br.ufpa.linc.MetriX.view.prefuse.data.column.ColumnMetadata;
...
import br.ufpa.linc.MetriX.view.prefuse.data.tuple.AbstractTupleSet;
...
import br.ufpa.linc.MetriX.view.prefuse.data.util.RowManager;
import br.ufpa.linc.MetriX.view.prefuse.data.util.Sort;
import br.ufpa.linc.MetriX.view.prefuse.data.util.TableIterator;
import br.ufpa.linc.MetriX.view.prefuse.data.util.TreeIndex;
 ...
 * in an object-oriented fashion using {@link Tuple}
 * instances that represent a single row of data in the table. As such,
 * tables implement the {@link TupleSet} interface.</p>
 * 
 ...
 * filtered by providing a {@link Predicate},
 ...
 * {@link Index} instances can be created and retrieved
...
public class Table extends AbstractTupleSet implements ColumnListener {
     ...
     * be parsed into an {@link Expression} instance.
     * The string is parsed by the
     * {@link ExpressionParser}. If an error
     ...
     * {@link EventConstants#ALL_COLUMNS} for operations
     * effecting all columns.
     * @param type the table modification type, one of
     * {@link EventConstants#INSERT},
     * {@link EventConstants#DELETE}, or
