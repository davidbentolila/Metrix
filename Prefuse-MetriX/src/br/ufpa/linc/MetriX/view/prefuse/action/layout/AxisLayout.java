package br.ufpa.linc.MetriX.view.prefuse.action.layout;
...
import br.ufpa.linc.MetriX.view.prefuse.data.query.NumberRangeModel;
import br.ufpa.linc.MetriX.view.prefuse.data.query.ObjectRangeModel;
import br.ufpa.linc.MetriX.view.prefuse.data.tuple.TupleSet;
import br.ufpa.linc.MetriX.view.prefuse.util.DataLib;
import br.ufpa.linc.MetriX.view.prefuse.util.MathLib;
import br.ufpa.linc.MetriX.view.prefuse.util.ui.ValuedRangeModel;
...
public class AxisLayout extends Layout {
     ...
     * @param group the data group to layout
     * @param field the data field upon which to base the layout
     * @param axis the axis type, either {@link Constants#X_AXIS}
     * or {@link Constants#Y_AXIS}.
     */
     ...
     * {@link ValuedRangeModel#getLowValue()} and
     * {@link ValuedRangeModel#getHighValue()} methods.
     ...
     * {@link Constants#LINEAR_SCALE}, 
     * {@link Constants#SQRT_SCALE}, or
     ...
     * {@link Constants#X_AXIS} or {@link Constants#Y_AXIS}.
     ...
     * {@link Constants#NOMINAL}, {@link Constants#ORDINAL},
     * {@link Constants#NUMERICAL}, or
