 ...
 * the {@link Display} class in response to the
 * {@link Display#setBackgroundImage(Image, boolean, boolean)} and
 * {@link Display#setBackgroundImage(String, boolean, boolean)}
 * methods.
 * 
