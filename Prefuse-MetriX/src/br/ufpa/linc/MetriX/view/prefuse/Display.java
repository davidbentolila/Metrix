...
import br.ufpa.linc.MetriX.view.prefuse.activity.SlowInSlowOutPacer;
import br.ufpa.linc.MetriX.view.prefuse.controls.Control;
import br.ufpa.linc.MetriX.view.prefuse.data.expression.AndPredicate;
...
import br.ufpa.linc.MetriX.view.prefuse.util.display.BackgroundPainter;
import br.ufpa.linc.MetriX.view.prefuse.util.display.Clip;
import br.ufpa.linc.MetriX.view.prefuse.util.display.DebugStatsPainter;
import br.ufpa.linc.MetriX.view.prefuse.util.display.ExportDisplayAction;
import br.ufpa.linc.MetriX.view.prefuse.util.display.ItemBoundsListener;
import br.ufpa.linc.MetriX.view.prefuse.util.display.PaintListener;
import br.ufpa.linc.MetriX.view.prefuse.util.display.RenderingQueue;
import br.ufpa.linc.MetriX.view.prefuse.util.io.IOLib;
import br.ufpa.linc.MetriX.view.prefuse.util.ui.JCustomTooltip;
...
import br.ufpa.linc.MetriX.view.prefuse.visual.sort.ItemSorter;
 ...
 * {@link Visualization} from which it pulls the items to visualize.
 * </p>
 * 
 * <p>To control which {@link VisualItem} instances are
 * drawn, the Display also maintains an optional 
 * {@link Predicate} for filtering items. The
 * drawing order of items is
 * controlled by an {@link ItemSorter} instance,
 * which calculates a score for each item. Items with higher scores
 * are drawn later, and hence on top of lower scoring items.
 * </p>
 * 
 * <p>The {@link Control Control}
 * interface provides the user interface callbacks for supporting
 * interaction. The {@link br.ufpa.linc.MetriX.view.prefuse.controls} package contains a number
 ...
 * {@link #editText(VisualItem, String)} methods.</p>
 * 
 * @version 1.0
...
public class Display extends JComponent {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -4598281530224056544L;
     ...
     * By default, all {@link VisualItem} instances in the
     ...
     * {@link ExpressionParser} to get a
     ...
     * Predicate.
     * @param visualization the {@link Visualization} backing this Display
     * @param predicate the filtering {@link Predicate}
     */
     ...
     * by this display.
     * @return the filtering {@link Predicate}
     */
     ...
     * parsed by the {@link ExpressionParser}.
     * If the parse fails or does not result in a
     * {@link Predicate} instance, an exception will
     * be thrown.
     */
     ...
     * Sets the filtering Predicate used to control what items are drawn by
     * this Display.
     * @param p the filtering {@link Predicate} to use
     */
     ...
     * by the ItemSorter.
     * @return this Display's {@link ItemSorter}
     */
     ...
     * {@link IOLib#urlFromString(String)} to resolve
     ...
     * {@link VisualItem#getBounds()} are not accurate and the
     * item's {@link Renderer} is drawing outside of the
     ...
     * about paint events.
     * @param pl the {@link PaintListener} to add
     */
     ...
     * @param pl the {@link PaintListener} to remove
     */
     ...
     * @param ibl the {@link ItemBoundsListener} to add
     */
     ...
     * occupied by the VisualItems in this Display change.
     * @param ibl the {@link ItemBoundsListener} to remove
     */
