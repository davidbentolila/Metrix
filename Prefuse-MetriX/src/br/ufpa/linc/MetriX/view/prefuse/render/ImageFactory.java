...
public class ImageFactory {
    ...
    protected Map imageCache =
        new LinkedHashMap((int) (m_imageCacheSize + 1 / .75F), .75F, true) {
			 ...
			 * 
			 */
			private static final long serialVersionUID = 3250935814020018269L;
    ...
    protected final Component component = new Component() {
		 ...
		 * 
		 */
		private static final long serialVersionUID = -8206541720948252246L;};
     ...
     * be instances of the {@link Tuple} class.</p>
     * 
     ...
     * 
     * @param iter an Iterator of {@link Tuple} instances
