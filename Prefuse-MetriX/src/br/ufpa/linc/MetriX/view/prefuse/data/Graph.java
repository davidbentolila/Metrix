...
import br.ufpa.linc.MetriX.view.prefuse.data.event.GraphListener;
...
import br.ufpa.linc.MetriX.view.prefuse.data.tuple.TableEdge;
import br.ufpa.linc.MetriX.view.prefuse.data.tuple.TableNode;
...
import br.ufpa.linc.MetriX.view.prefuse.data.util.Index;
import br.ufpa.linc.MetriX.view.prefuse.data.util.NeighborIterator;
import br.ufpa.linc.MetriX.view.prefuse.util.PrefuseConfig;
import br.ufpa.linc.MetriX.view.prefuse.util.TypeLib;
import br.ufpa.linc.MetriX.view.prefuse.util.collections.CompositeIntIterator;
...
import br.ufpa.linc.MetriX.view.prefuse.util.collections.IntArrayIterator;
 ...
 * for each, or using the {@link Node} and
 * {@link Edge} classes --
 * {@link Tuple} instances that provide
...
public class Graph extends CompositeTupleSet {
     ...
     * {@link br.ufpa.linc.view.prefuse.data.event.EventConstants#ALL_COLUMNS} for operations
     * affecting all columns
     * @param type the type of modification, one of
     * {@link br.ufpa.linc.view.prefuse.data.event.EventConstants#INSERT},
     * {@link br.ufpa.linc.view.prefuse.data.event.EventConstants#DELETE}, or
     * {@link br.ufpa.linc.view.prefuse.data.event.EventConstants#UPDATE}.
     */
