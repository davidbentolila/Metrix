...
import br.ufpa.linc.MetriX.view.prefuse.data.util.TreeNodeIterator;
...
public class SquarifiedTreeMapLayout extends TreeLayout {
    ...
    private static Comparator<Object> s_cmp = new Comparator<Object>() {
    ...
    private ArrayList<Object> m_kids = new ArrayList<Object>();
    private ArrayList<VisualItem> m_row  = new ArrayList<VisualItem>();
    ...
    private void squarify(List<Object> c, List<VisualItem> row, double w, Rectangle2D r) {
    ...
    private double worst(List<VisualItem> rlist, double w) {
        double rmax = Double.MIN_VALUE, rmin = Double.MAX_VALUE, s = 0.0;
        Iterator<VisualItem> iter = rlist.iterator();
        while ( iter.hasNext() ) {
    ...
    private Rectangle2D layoutRow(List<VisualItem> row, double w, Rectangle2D r) {        
