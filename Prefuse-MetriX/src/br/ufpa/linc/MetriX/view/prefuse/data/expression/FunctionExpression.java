    ...
    implements Function
{
    ...
    /**
     * @see br.ufpa.linc.view.prefuse.data.expression.Function#getNome()
     */
    public abstract String getName();
    
    /**
     * @see br.ufpa.linc.view.prefuse.data.expression.Function#addParameter(br.ufpa.linc.view.prefuse.data.expression.Expression)
     */
