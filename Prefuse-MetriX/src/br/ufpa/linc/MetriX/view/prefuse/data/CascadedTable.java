...
import br.ufpa.linc.MetriX.view.prefuse.data.util.AcceptAllColumnProjection;
import br.ufpa.linc.MetriX.view.prefuse.data.util.CascadedRowManager;
import br.ufpa.linc.MetriX.view.prefuse.data.util.ColumnProjection;
import br.ufpa.linc.MetriX.view.prefuse.data.util.ValidEdgePredicate;
 ...
 * a {@link Predicate} that filters the parent rows.
 * Columns of the parent table can be selectively included by providing
 * a {@link ColumnProjection} indicating the columns to
 * include.</p>
 * 
...
public class CascadedTable extends Table {
    ...
    /**
     * @see Table#getColumnNumber(Column)
     */
    ...
    /**
     * @see br.ufpa.linc.view.prefuse.data.Table#hasColumn(java.lang.String)
     */
    ...
    /**
     * @see br.ufpa.linc.view.prefuse.data.Table#getColumnNames()
     */
