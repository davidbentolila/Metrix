...
public class DefaultLiteralComparator implements LiteralComparator {
    ...
    /**
     * @see LiteralComparator#compare(byte, byte)
     */
    ...
    /**
     * @see LiteralComparator#compare(int, int)
     */
    ...
    /**
     * @see LiteralComparator#compare(long, long)
     */
    ...
    /**
     * @see LiteralComparator#compare(float, float)
     */
    ...
    /**
     * @see LiteralComparator#compare(double, double)
     */
    ...
    /**
     * @see LiteralComparator#compare(boolean, boolean)
     */
