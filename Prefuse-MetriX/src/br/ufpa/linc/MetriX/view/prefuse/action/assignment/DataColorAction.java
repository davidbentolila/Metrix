...
import br.ufpa.linc.MetriX.view.prefuse.util.ColorMap;
...
public class DataColorAction extends ColorAction {
     ...
     * or {@link Constants#NUMERICAL}, for whether the data field
     ...
     * {@link ColorLib} for color palette generators.
     */
    public DataColorAction(String group, String dataField, 
     ...
     * This value is only used for {@link Constants#NUMERICAL}
     * data.
     * @return the scale type. One of
     * {@link Constants#LINEAR_SCALE},
     * {@link Constants#LOG_SCALE}, 
     * {@link Constants#SQRT_SCALE},
     * {@link Constants#QUANTILE_SCALE}.
     */
    public int getScale() {
        return m_scale;
    }
     ...
     * {@link Constants#NUMERICAL} data.
     * @param scale the scale type to use. This value should be one of
     * {@link Constants#LINEAR_SCALE}, 
     * {@link Constants#SQRT_SCALE},
     * {@link Constants#LOG_SCALE},
     * {@link Constants#QUANTILE_SCALE}.
     * If {@link Constants#QUANTILE_SCALE} is used, the number of
     ...
     * @see ColorAction#setDefaultColor(int)
     ...
     * {@link DataLib} class. This method allows you to set your
    ...
    /**
     * @see ColorAction#getColor(VisualItem)
     */
